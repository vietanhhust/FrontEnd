...
@Component({
  selector: 'cms-dashboard-table',
  templateUrl: './cms-dashboard-table.component.html',
  styleUrls: ['./cms-dashboard-table.component.scss']
})
export class CMSDashboardTableComponent implements OnInit, AfterViewInit, OnChanges {
  @Input() data: any[];
